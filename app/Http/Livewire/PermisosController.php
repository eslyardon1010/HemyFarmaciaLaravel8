...
public function mount() 
{
  ...
  $this->componentName = 'Permisos';
    ...
    public function CreatePermission(){
        $rules = [
            'permissionName' => 'required|min:2|unique:roles,name'
        ];
        $messages = [
        ...
        $this->emit('permiso-added', 'Se registro del permiso con exito');
        $this->resetUI();
    }
    ...
    public function UpdatePermission() {
        $rules = [
            'permissionName' => "required|min:2|unique:roles,name, {$this->selected_id}"
        ];
        $messages = [
            'permissionName.required' => 'El nombre es requerido',
            'permissionName.unique' => 'El permiso ya existe',
        ...
        $this->emit('permiso-updated', 'Se actualizo el registro con exito');
        $this->resetUI();
    }

...
@if($total>0)
     ...
     <table class="table table-bordered table-striped mt-1">
         <thead class="text-white" style="background:#CB3234">
<tr>
    <th width="100%">
...
<th class="table-th text-center text-white">ACTIONS</th>
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td class="text-center">L{{number_format($item->price,2)}}</td>
                 <td>
                 ...
                 <td class="text-center">
                   <h6>
                      L{{number_format($item->price * $item->quantity),2}}
                   </h6>
                 </td>
                 <td class="text-center">
                    <button
                    ...
                    class="btn btn-dark mbmobile">
                     ...
                     <button wire:click.prevent="descreaseQty({{$item->id}})" class="btn btn-dar mbmobile">
                     <i class="fas fa-minus"></i>
                     </button>
                     <buttom wire:click.prevent="increaseeQty({{$item->id}})" class="btn btn-dar mbmobile">
                     <i class="fas fa-minus"></i>
                     </button>
                 </td>
             </tr>
